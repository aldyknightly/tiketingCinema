...
function App() {
  ...
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
    <a href="https://github.com/aldyknightly/devasc-study-team" target="_blank" rel="noopener noreferrer">
      <img src="https://repository-images.githubusercontent.com/322583197/e7958f30-5dcf-4101-9f18-63aa08a338bb"  width={40} alt="GitHub" />
    </a>
    <p style={{ fontWeight: "bold", marginTop: "10px" }}>Aldyknightly @CinemaXXINDO</p>
  </div>
